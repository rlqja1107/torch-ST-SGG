...
class CombinedROIHeads(torch.nn.ModuleDict):
    ...
    def __init__(self, cfg, heads):
        ...
        if "HetSGG" in self.cfg.MODEL.ROI_RELATION_HEAD.PREDICTOR:
            if 'vg' in self.cfg.DATA_DIR:
                self.vg_cat_dict = json.load(open(f'{cfg.DATA_DIR}/{cfg.MODEL.ROI_RELATION_HEAD.HETSGG.CATEGORY_FILE}.json', 'r'))
            else:
