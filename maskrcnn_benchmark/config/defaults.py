...
_C.OBJ_PRED_INFO_PATH = "initial_data/obj_pred_info/obj_pred_info_50"
...
_C.WSUPERVISE.LOSS_TYPE = "ce"

_C.SUPERVISE = CN()
_C.SUPERVISE.LOSS_TYPE = 'ce'
...
# Ablation
_C.MODEL.ROI_RELATION_HEAD.BGNN_MODULE.TYPE_GLOBAL_FEATURE= 'FPN'
_C.MODEL.ROI_RELATION_HEAD.BGNN_MODULE.USE_GLOBAL_CONTEXT = False
_C.MODEL.ROI_RELATION_HEAD.BGNN_MODULE.USE_OBJ_OR_REL_CONTEXT = 'obj'
_C.MODEL.ROI_RELATION_HEAD.BGNN_MODULE.OUTER_CONCAT = False
_C.MODEL.ROI_RELATION_HEAD.BGNN_MODULE.GRAPH_HIDDEN_DIM = 512 # the hidden dimension of graph model
_C.MODEL.ROI_RELATION_HEAD.BGNN_MODULE.REFINE_OBJ = False
_C.MODEL.ROI_RELATION_HEAD.BGNN_MODULE.GRAPH_POOLING = 'mean'
_C.MODEL.ROI_RELATION_HEAD.BGNN_MODULE.IS_FULLY_CONNECTED = False
...
_C.MODEL.ROI_RELATION_HEAD.STSGG_MODULE = CN()
_C.MODEL.ROI_RELATION_HEAD.STSGG_MODULE.BETA = 1.0
_C.MODEL.ROI_RELATION_HEAD.STSGG_MODULE.ALPHA_INC = 0.4
_C.MODEL.ROI_RELATION_HEAD.STSGG_MODULE.ALPHA_DEC = 0.4
_C.MODEL.ROI_RELATION_HEAD.STSGG_MODULE.USE_GSL_OUTPUT = True