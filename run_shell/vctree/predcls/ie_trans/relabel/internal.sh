...
OUTPATH="checkpoints/50/vctree/predcls/ie_trans" # put the pre-trained model's path
MODEL_WEIGHT_PATH="checkpoints/50/vctree/predcls/ie_trans/pretrain/model_???.pth" # Insert the pretraiend model weight on predcls task
