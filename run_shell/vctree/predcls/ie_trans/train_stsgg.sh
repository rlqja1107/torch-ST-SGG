...
num_gpu=2
OUTPATH="checkpoints/50/vctree/predcls/st_sgg" # save directory
GLOVE_DIR="/home/public/Datasets/CV/vg_bm" # Glove directory
SPECIFIED_PATH="checkpoints/50/vctree/Final/no_ext_yes_int.pk"
ALPHA_DEC=0.4
ALPHA_INC=0.4
MODEL_WEIGHT_PATH="checkpoints/50/vctree/predcls/no_ext_yes_int/model_???.pth" # Path of pretrained model
