...
num_gpu=2
OUTPATH="checkpoints/50/bgnn/predcls/st_sgg" # save directory
GLOVE_DIR="Glove
SPECIFIED_PATH="datasets/50/bgnn/BGNN_i-trans.pk"
ALPHA_DEC=0.4
ALPHA_INC=0.4
MODEL_WEIGHT_PATH="checkpoints/50/bgnn/predcls/no_ext_yes_int/model_???.pth" # Path of pretrained model
...
if $mutli_gpu;then
  python -m torch.distributed.launch \
    ...
    MODEL.ROI_RELATION_HEAD.PREDICTOR BGNNPredictor_STSGG \
