...
num_gpu=2
OUTPATH="checkpoints/50/bgnn/predcls/base_stsgg" # save directory
GLOVE_DIR="/home/public/Datasets/CV/vg_bm" # Glove directory

#ST-SGG Hyper-parameter
ALPHA_DEC=0.4
ALPHA_INC=0.8
PRETRAINED_WEIGHT_PATH="checkpoints/50/bgnn/predcls/base/model_???.pth" # Path of pretrained model
mkdir -p $OUTPATH
