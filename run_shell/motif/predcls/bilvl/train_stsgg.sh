...
num_gpu=1
OUTPATH="checkpoints/50/motif/predcls/bilvl_stsgg" # save directory
GLOVE_DIR="Glove" # Glove directory
ALPHA_DEC=0.4
ALPHA_INC=0.4
MODEL_WEIGHT_PATH="checkpoints/50/motif/predcls/bilvl/model_???.pth" # Path of pretrained model
mkdir -p $OUTPATH
