...
num_gpu=2
OUTPATH="checkpoints/50/motif/sgdet/st_sgg" # save directory
GLOVE_DIR="Glove" # Glove directory
SPECIFIED_PATH="datasets/50/motif/Motif_i-trans.pk"
ALPHA_DEC=0.4
ALPHA_INC=0.4
MODEL_WEIGHT_PATH="checkpoints/50/motif/sgdet/no_ext_yes_int/model_???.pth" # Path of pretrained model
mkdir -p $OUTPATH
