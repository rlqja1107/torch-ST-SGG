...
num_gpu=2
OUTPATH="checkpoints/50/motif/sgdet/base_stsgg" # save directory
GLOVE_DIR="Glove" # Glove directory

#ST-SGG Hyper-parameter
ALPHA_DEC=0.4
ALPHA_INC=0.8
PRETRAINED_WEIGHT_PATH="checkpoints/50/motif/sgdet/base/model_???.pth" # Path of pretrained model
mkdir -p $OUTPATH
